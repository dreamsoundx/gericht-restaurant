(() => {
    ...
    function initSliders() {
        if (document.querySelector(".body-main-slider")) new swiper_core_Swiper(".body-main-slider", {
            ...
            on: {
                init: function() {
                    const controll = document.querySelector(".body-main-slider__controll").children;
