    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider")) {
                const mainSlider = new swiper_core_Swiper(".body-main-slider", {
                ...
                function controllElementsPosition() {
                    const controllElementInit = document.querySelectorAll("._init-bullet");
                    if (controllElementInit.length) controllElementInit.forEach((element => {
                        element.classList.remove("_init-bullet");
                    }));
                    let controll = document.querySelector(".swiper-pagination-bullets-dynamic");
                    if (controll) {
                        if (controll.lastElementChild.classList.contains("swiper-pagination-bullet-active-main")) {
                            let lastElement = document.querySelector(".swiper-pagination-bullet-active-prev-prev");
                            if (lastElement) lastElement.classList.add("_init-bullet");
                        }
                        if (controll.firstElementChild.classList.contains("swiper-pagination-bullet-active-main")) {
                            let firstElement = document.querySelector(".swiper-pagination-bullet-active-next-next");
                            if (firstElement) firstElement.classList.add("_init-bullet");
                        }
                    }
                }
                controllElementsPosition();
                mainSlider.on("slideChange", (function() {
                    controllElementsPosition();
                }));
            }
            if (document.querySelector(".gallery__slider")) {
                let gallerySlider = new swiper_core_Swiper(".gallery__slider", {
